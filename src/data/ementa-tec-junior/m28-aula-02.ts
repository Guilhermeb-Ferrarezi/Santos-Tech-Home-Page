...
Conteúdo novo guiado (15 min): No projetor, faça o caminho completo devagar, narrando cada clique. 1. Clique no modelo no palco e mostre a borda laranja: "isto é selecionar". 2. Aperte "Ctrl + A" e clique em "All Transforms": "isto congela o tamanho e o giro". 3. Vá em "File" (Arquivo), depois "Export" (Exportar), depois "Wavefront (.obj)". 4. Mostre o campo "Scale" (Escala) à direita e confirme que está 1.00. 5. Em cima, escolha a pasta "Meus Modelos 3D" e digite o nome, por exemplo "robo-do-pedro". 6. Clique no botão azul "Export Wavefront OBJ". Por fim, minimize o Blender e abra a pasta para mostrar o arquivo lá dentro: "conferimos, está aqui!".
