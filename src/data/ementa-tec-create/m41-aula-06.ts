...
25 min — Mão na massa. Cada aluno finaliza o material do próprio asset: escolhe cor base, ajusta Roughness para combinar com o material real (metal mais liso, madeira mais fosca) e, quando tiver UV, aplica uma textura de imagem. Em paralelo, peça que conversem com o Claude. Sugira este pedido exato para colar no chat: Sou aluno e estou texturizando um [diga o objeto] para um jogo estilo [diga o estilo]. Me sugira uma paleta de 4 cores em codigo hexadecimal e um acabamento (fosco ou brilhante) que combinem, e explique o porque. O aluno aplica uma sugestão, ligando a luz no modo Rendered para conferir.
