  ...
  exercicios: [
    {
      ...
      atividade: `Leia este prompt e identifique onde está cada um dos quatro elementos: "Aja como um professor paciente de C# para Unity. Estou fazendo um jogo de plataforma e meu personagem nao pula quando aperto a barra de espaco. Quero descobrir o motivo. Me de um passo a passo numerado do que verificar." Diga qual trecho é o contexto, qual é o objetivo, qual é o formato e qual é o papel da IA.`,
      gabarito: `Papel da IA: "Aja como um professor paciente de C# para Unity". Contexto: "Estou fazendo um jogo de plataforma e meu personagem nao pula quando aperto a barra de espaco". Objetivo: "Quero descobrir o motivo". Formato: "Me de um passo a passo numerado do que verificar". Os quatro elementos aparecem, cada um em uma frase curta.`,
    },
    {
