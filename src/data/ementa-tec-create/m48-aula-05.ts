...
Aquecimento (10 min): pergunte "qual jogo que vocês conhecem tem um som que vocês nunca esquecem?". Deixe dois ou três falarem. Explique a frase do dia: "hoje a gente não cria coisas novas, a gente deixa o que ja existe mais gostoso de jogar". Apresente a ficha de playtest.
...
Desafio + compartilhar (10 min): desafio "som com proposito": que cada aluno garanta que pelo menos um som so toca quando uma acao especifica acontece (acerto ou dano), e não o tempo todo. Para fechar, dois ou três alunos mostram no projetor o antes e o depois de um ajuste.

## Como explicar de forma clara (linguagem para a idade)

Use a ideia de "tempero". Diga: "a comida ja esta pronta; agora a gente coloca sal e tempero para ficar deliciosa". Som, HUD e tremor de camera sao temperos. Sobre feedback, use o exemplo do celular: quando você digita a senha errada, o celular treme; isso e o aparelho te avisando sem palavras. Sobre priorizar, explique com a imagem de arrumar a mochila: primeiro entra o que você mais precisa. Reforce que polir não e ficar adicionando coisas novas para sempre; e fechar bem o que ja existe.

## Erros comuns e como ajudar

O som não toca: quase sempre o pino de execucao (a seta branca) não foi conectado ao no Play Sound, ou o campo Sound ficou vazio. Peca para o aluno seguir a seta branca com o dedo na tela. O HUD não aparece: faltou o Add to Viewport depois do Create Widget, ou o Create Widget foi colocado fora do BeginPlay. O tremor não acontece: o aluno esqueceu o Get Player Controller antes do Client Start Camera Shake. Aluno querendo refazer o jogo inteiro: lembre que hoje so polimos, e que mudancas grandes ficam para depois do Demo Day. Lista de bugs sem fim: oriente a escolher apenas os três primeiros itens da lista do Claude e ignorar o resto por enquanto.`,
  exercicios: [
    {
